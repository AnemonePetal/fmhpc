...
def main():
    print('Sensitivity analysis: Effect of epsilon on TRGs')

    print('> Graph similarity analysis on JLAB')
    args = get_args()
    args.dataset = 'jlab'
    args.model = 'fm'
    ...
    model.sensitity_graph_epsilon_eval()

    print('> Graph similarity analysis on OLCF')
    args = get_args()
