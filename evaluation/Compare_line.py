...
def line_plot_wrapper(df, feats, time_range, savefile, farmnode="farm140109:9100",y_min_1=-1,y_max_1=-1,title=""):
    ...
    plt.subplots_adjust(left=0.16, right=0.9, top=0.93, bottom=0.05)
...
if __name__ == "__main__":
    ...
    line_plot_wrapper(data.train, fpath_feats[0], time_ranges, savefile = 'fig7_c.png',y_min_1=0.2,y_max_1=1.2,title="Mantis TRG connection on JLab")
    line_plot_wrapper(data.train, fpath_feats[1], time_ranges, savefile = 'fig7_d.png',y_min_1=0,y_max_1=0,title="GDN graph connection on JLab")
    ...
    line_plot_wrapper2(data.train, fpath_feats[0], time_ranges, savefile = 'fig7_a.png', farmnode='a30n04',y_min_1=0,y_max_1=4,title="Mantis TRG connection on OLCF")
    line_plot_wrapper2(data.train, fpath_feats[1], time_ranges, savefile = 'fig7_b.png', farmnode='a30n04',y_min_1=0,y_max_1=0,title="GDN graph connection on OLCF")
